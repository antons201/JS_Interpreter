...
public:
  ...
  virtual void enterAnoymousFunctionDecl(JavaScriptParser::AnoymousFunctionDeclContext *ctx) = 0;
  virtual void exitAnoymousFunctionDecl(JavaScriptParser::AnoymousFunctionDeclContext *ctx) = 0;
